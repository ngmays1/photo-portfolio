...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    ...
    secondary: "bg-white text-slate-900 hover:bg-slate-50 focus:ring-slate-200 border border-slate-200 shadow-sm",
    outline: "bg-transparent border border-slate-300 text-slate-700 hover:border-slate-800 hover:text-slate-900",
